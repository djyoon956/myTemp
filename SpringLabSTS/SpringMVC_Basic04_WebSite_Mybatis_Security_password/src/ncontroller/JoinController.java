...
import validator.MemberRegistValidator;
import vo.Member;
...
public class JoinController {
	...
	public String join(@ModelAttribute("member") Member member, Errors errors)
			throws ClassNotFoundException, SQLException {
		System.out.println(member.toString());

		int result = 0;
		String viewpage = "";
		new MemberRegistValidator().validate(member, errors);
